  ...
  <div class="app-container">
    <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading"  :rules="rules">
      ...
      <el-form-item label="选项：" required>
        <el-form-item :label="item.prefix" :key="item.prefix" @click.native="inputClick(item,'content')" v-for="(item,index) in form.items"  label-width="50px" class="question-item-label">
