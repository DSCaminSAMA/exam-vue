...
const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'question/edit/simplifiedCalculation',
        component: () => import('@/views/exam/question/edit/simplifiedCalculation'),
        name: 'simplifiedCalculation',
        meta: { title: '画图题', noCache: true, activeMenu: '/exam/question/list' },
        hidden: true
      },
      {
        path: 'question/edit/integratedApplication',
        component: () => import('@/views/exam/question/edit/integratedApplication'),
        name: 'integratedApplication',
        meta: { title: '综合应用题', noCache: true, activeMenu: '/exam/question/list' },
        hidden: true
      },
      {
        path: 'question/edit/analysisAndDesign',
        component: () => import('@/views/exam/question/edit/analysisAndDesign'),
        name: 'analysisAndDesign',
        meta: { title: '分析与设计', noCache: true, activeMenu: '/exam/question/list' },
        hidden: true
      },
    ]
  },
